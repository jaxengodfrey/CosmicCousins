...
ax[i_0] = plot_mean_and_90CI(ax[i_0], subpop_ppds['mass_ratio'], subpop_ppds['peak_1_mass_ratio_pdfs'], color ='tab:cyan', label=rf'{popA_label}{first_label}', bounds = True, lw = 2, line_style = '--', fill_alpha = fill)
...
ax[i_0] = plot_mean_and_90CI(ax[i_0], subpop_ppds['mass_ratio'], subpop_ppds['continuum_mass_ratio_pdfs'], color ='tab:pink', label=rf'{popB_label}{contB_label}', bounds = True, lw = 2, line_style = (0, (1, 1)), fill_alpha = fill)
...
ax[i_1] = plot_mean_and_90CI(ax[i_1], subpop_ppds['mass_ratio'], subpop_ppds['peak_1_mass_ratio_pdfs'], color ='tab:cyan', label=rf'{popA_label}{first_label}', bounds = True, lw = 2, line_style = '--', fill_alpha = fill)
...
ax[i_1] = plot_mean_and_90CI(ax[i_1], subpop_ppds['mass_ratio'], subpop_ppds['continuum_1_mass_ratio_pdfs'], color ='tab:purple', label=rf'{popA_label}{contA_label}', bounds = True, lw = 2, line_style = (0, (1, 1)), fill_alpha = fill)
ax[i_1] = plot_mean_and_90CI(ax[i_1], subpop_ppds['mass_ratio'], subpop_ppds['continuum_mass_ratio_pdfs'], color ='tab:pink', label=rf'{popB_label}{contB_label}', bounds = True, lw = 2, line_style = (0, (1, 1)), fill_alpha = fill)
