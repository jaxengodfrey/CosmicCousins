...
ax[i_0] = plot_mean_and_90CI(ax[i_0], subpop_ppds['mass_ratio'], subpop_ppds['continuum_mass_ratio_pdfs'], color ='tab:pink', label='Continuum B', bounds = True, lw = 2, line_style = (0, (1, 1)), fill_alpha = fill)
...
ax[i_1] = plot_mean_and_90CI(ax[i_1], subpop_ppds['mass_ratio'], subpop_ppds['peak_1_mass_ratio_pdfs'], color ='tab:cyan', label='Peak A', bounds = True, lw = 2, line_style = '--', fill_alpha = fill)
...
ax[i_1] = plot_mean_and_90CI(ax[i_1], subpop_ppds['mass_ratio'], subpop_ppds['continuum_1_mass_ratio_pdfs'], color ='tab:purple', label='Continuum A', bounds = True, lw = 2, line_style = (0, (1, 1)), fill_alpha = fill)
ax[i_1] = plot_mean_and_90CI(ax[i_1], subpop_ppds['mass_ratio'], subpop_ppds['continuum_mass_ratio_pdfs'], color ='tab:pink', label='Continuum B', bounds = True, lw = 2, line_style = (0, (1, 1)), fill_alpha = fill)
...
ax[i_1].set_title('Composite Model Mass Ratio Distributions')
...
fig.tight_layout()
plt.savefig(paths.figures / 'mass_ratio_distribution_plot.pdf', dpi=300);
plt.savefig(paths.figures / 'mass_ratio_distribution_plot.jpeg', dpi=300);
