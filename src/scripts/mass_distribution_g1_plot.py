...
ax1 = plot_mean_and_90CI(ax1, subpop_ppds['mass_1'], tot_subpops[10000:], color ='black', label='Total, this work', bounds = True, mean = False, median = True)
...
ax = plot_mean_and_90CI(ax, subpop_ppds['mass_1'], tot_subpops[10000:], color ='black', label='Total', bounds = False, mean = False, median = True)
ax = plot_mean_and_90CI(ax, subpop_ppds['mass_1'], subpop_ppds['peak_1_mass_pdfs'][10000:], color ='tab:cyan', label='Peak A', bounds = True, alpha = 0.75, line_style = '--', lw = 3, mean = False, median = True)
ax = plot_mean_and_90CI(ax, subpop_ppds['mass_1'], subpop_ppds['continuum_mass_pdfs'][10000:], color ='tab:pink', label='Continuum B', bounds = True, alpha = 0.75, line_style = (0, (1, 1)), lw = 3, mean = False, median = True)
