...
from utils import plot_mean_and_90CI, load_macro
import matplotlib
...
g1_ppds = GWInfernoData.from_netcdf(paths.data / "bspline_1logpeak_marginalized_fixtau_m1-s25-z1_msig15_qsig5_ssig5_zsig1_sigp3_NeffNobs_downsample_100k_rng1-2_ppds.h5").pdfs
g2_ppds = GWInfernoData.from_netcdf(paths.data / "bspline_composite_marginalized_fixtau_m1-s25-z1_msig15_qsig5_ssig5_zsig1_sigp3_NeffNobs_downsample_100k_rng6-10_ppds.h5").pdfs
...
ax = plot_mean_and_90CI(ax, cyb_ppds['zs'], cyb_ppds['Rofz'], color='tab:red', label='Edelman et. al. 2022', bounds=False, mean = False, median = True)
ax.set_xscale('log')
ax.set_yscale('log')
