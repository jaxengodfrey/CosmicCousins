...
Figure \ref{fig:mass_ratio_distribution} shows the mass ratio distributions of the \base{} and \comp{}. \NewChange{The mass ratio of \popA{} in the \base{} peaks away from $q=1$, near $q\sim0.7$, while \popB{} follows a more power-law like shape. In the \comp{}, \popB{} reflects that of \popB{} in \base{}, as does \contA{}. The mass ratio distribution of the $10\msun$ peak is therefore distinct from the rest of the population.} The total mass ratio distributions for both models are consistent with the total inferred by \brucepaper.
