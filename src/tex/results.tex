...
\begin{table*}[]
    ...
    \hline
    \multicolumn{1}{|c|}{\textbf{\begin{tabular}[c]{@{}c@{}}Isolated Peak \\ Model\end{tabular}}} &
    ...
    \multicolumn{1}{|c|}{\textbf{\begin{tabular}[c]{@{}c@{}}Peak+Continuum \\ Model\end{tabular}}} &
      \multicolumn{1}{c|}{$\lambda$} &
      \multicolumn{1}{c|}{$N_\text{events}$} &
      \multicolumn{1}{c|}{$a_\text{peak}$} &
      \multicolumn{1}{c|}{$\cos{}(\theta)_\text{peak}$} &
