...
% \IfFileExists{output/macros.tex}{\result{$\CIPlusMinus{\macros[Mass][Continuum][10percentile]}\,\msun$}}{\result{$\CIPlusMinus{\variable{output/macros.tex}[Mass][Continuum][10percentile]}\,\msun$}}

\result{$\CIPlusMinus{\variable{output/macros.tex}[Mass][Continuum][10percentile]}\,\msun$}
