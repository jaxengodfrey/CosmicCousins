...
\begin{table*}[]
    ...
    \multicolumn{1}{|l|}{Peak A} &
      ...
      $\CIPlusMinus{\macros[NumEvents][Composite][PeakA]}$ &
      \multirow{2}{*}{$\CIPlusMinus{\macros[SpinMag][Composite][PeakAContinuumA][max]}$} &
      \multirow{2}{*}{$\CIPlusMinus{\macros[CosTilt][Composite][PeakAContinuumA][max]}$} &
      \multirow{2}{*}{$\CIPlusMinus{\macros[ChiEff][Composite][PeakAContinuumA][max]}$} &
      \multirow{2}{*}{$\CIPlusMinus{\macros[ChiEff][Composite][PeakAContinuumA][negfrac]}$} &
      \multirow{2}{*}{$\CIPlusMinus{\macros[ChiEff][Composite][PeakAContinuumA][less01frac]}$} &
      \multirow{2}{*}{$\CIPlusMinus{\macros[ChiEff][Composite][PeakAContinuumA][fdyn]}$} &
      \multirow{2}{*}{$\CIPlusMinus{\macros[ChiEff][Composite][PeakAContinuumA][fhm]}$} \\ \cline{1-3}
    \multicolumn{1}{|l|}{Continuum A} &
      \multicolumn{1}{c|}{$\CIPlusMinusPer{\macros[BranchingRatios][Composite][ContinuumA][Percent]}$} &
      $\CIPlusMinus{\macros[NumEvents][Composite][ContinuumA]}$ &
       &
       &
       &
       &
    ...
    \multicolumn{1}{|l|}{Continuum B} &
      ...
      $\CIPlusMinus{\macros[NumEvents][Composite][ContinuumB]}$ &
      $\CIPlusMinus{\macros[SpinMag][Composite][ContinuumB][max]}$ &
      $\CIPlusMinus{\macros[CosTilt][Composite][ContinuumB][max]}$ &
      $\CIPlusMinus{\macros[ChiEff][Composite][ContinuumB][max]}$ &
      $\CIPlusMinus{\macros[ChiEff][Composite][ContinuumB][negfrac]}$ &
      $\CIPlusMinus{\macros[ChiEff][Composite][ContinuumB][less01frac]}$ &
      $\CIPlusMinus{\macros[ChiEff][Composite][ContinuumB][fdyn]}$ &
      $\CIPlusMinus{\macros[ChiEff][Composite][ContinuumB][fhm]}$ \\ \hline
    \end{tabular}
    \end{table*}
% Please add the following required packages to your document preamble:
% \usepackage{multirow}
...
%     \hline
%     \multicolumn{1}{|c|}{\textbf{\begin{tabular}[c]{@{}c@{}}Base \\ Model\end{tabular}}} &
%       \multicolumn{1}{c|}{\begin{tabular}[c]{@{}c@{}}Branching \\ Ratio\end{tabular}} &
%       \begin{tabular}[c]{@{}c@{}}Number of \\ Events\end{tabular} &
%       $a_\text{peak}$ &
%       $cos(\theta_\text{peak})$ &
%       $\chi_\text{eff, peak}$ &
%       $f_{\chi_\text{eff}<0}$ &
%       $f_{\chi_\text{eff}<0.1}$ \\ \hline
%     \multicolumn{1}{|l|}{Peak A} &
%       \multicolumn{1}{c|}{$\CIPlusMinusPer{\macros[BranchingRatios][Base][Peak][Percent]}$} &
%       $\CIPlusMinus{\macros[NumEvents][Base][PeakA]}$ &
%       $\CIPlusMinus{\macros[SpinMag][Base][PeakA][max]}$ &
%       $\CIPlusMinus{\macros[CosTilt][Base][PeakA][max]}$ &
%       $\CIPlusMinus{\macros[ChiEff][Base][PeakA][max]}$ &
...
%        \\ \hline
%     \multicolumn{1}{|l|}{Continuum B} &
%       \multicolumn{1}{c|}{$\CIPlusMinusPer{\macros[BranchingRatios][Base][Continuum][Percent]}$} &
%       $\CIPlusMinus{\macros[NumEvents][Base][ContinuumA]}$ &
%       $\CIPlusMinus{\macros[SpinMag][Base][ContinuumB][max]}$ &
%       $\CIPlusMinus{\macros[CosTilt][Base][ContinuumB][max]}$ &
%       $\CIPlusMinus{\macros[ChiEff][Base][ContinuumB][max]}$ &
%       $\CIPlusMinus{\macros[ChiEff][Base][PeakA][negfrac]}$ &
...
%       \multicolumn{1}{c|}{$\CIPlusMinusPer{\macros[BranchingRatios][Composite][PeakA][Percent]}$} &
%       $\CIPlusMinus{\macros[NumEvents][Composite][PeakA]}$ &
%       \multirow{2}{*}{$\CIPlusMinus{\macros[SpinMag][Composite][PeakA+ContinuumA][max]}$} &
%       \multirow{2}{*}{$\CIPlusMinus{\macros[CosTilt][Composite][PeakA+ContinuumA][max]}$} &
%       \multirow{2}{*}{$\CIPlusMinus{\macros[ChiEff][Composite][PeakA+ContinuumA][max]}$} &
%       \multirow{2}{*}{$\CIPlusMinus{\macros[ChiEff][Base][PeakA][negfrac]}$} &
%       \multirow{2}{*}{} \\ \cline{1-3}
%     \multicolumn{1}{|l|}{Continuum A} &
%       \multicolumn{1}{c|}{$\CIPlusMinusPer{\macros[BranchingRatios][Composite][ContinuumA][Percent]}$} &
%       $\CIPlusMinus{\macros[NumEvents][Composite][ContinuumA]}$ &
%        &
